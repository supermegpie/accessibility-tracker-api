        ...
        for (const businessType of BUSINESS_TYPES) {
            ...
            try {
                ...
                for (const place of places) {
                    ...
                    const existing = await pool.query('SELECT id FROM businesses WHERE google_place_id = $1', [place.place_id]);
                    ...
                    try {
                        ...
                        wheelchairAccessible = detailsResponse.data.result.wheelchair_accessible_entrance || false;
